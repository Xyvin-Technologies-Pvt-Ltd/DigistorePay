    ...
    <div className={classes.mainContainer}>
      ...
      <form className={classes.form}>
        ...
        {errors.employment && touched.employment && (
          <p className={classes.errors}>{errors.employment}</p>
        )}
        ...
        {errors.dateOfJoin && touched.dateOfJoin && (
          <p className={classes.errors}>{errors.dateOfJoin}</p>
        )}

        <div className={classes.trainingContainer}>
          <label className={classes.labelStyle}>
            Need Training?<span style={{ color: "red" }}>*</span>
          </label>
        ...
        {errors.isTrainingRequired && touched.isTrainingRequired && (
          <p className={classes.errors}>{errors.isTrainingRequired}</p>
        )}

        {isTrainingRequired && (
          <>
            <div className={classes.trainingDaysContainer}>
              <label htmlFor="trainingDays" className={classes.labelStyle}>
              ...
              {errors.totalTrainingDays && touched.totalTrainingDays && (
                <p className={classes.errors}>{errors.totalTrainingDays}</p>
              )}
            </div>
          </>
        )}
