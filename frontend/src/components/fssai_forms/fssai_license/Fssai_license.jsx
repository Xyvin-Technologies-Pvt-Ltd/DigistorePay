...
import { fssaiSchema } from "../../../Validations/service_component_validations/tax_filing/taxFilingValidation";
import { toast } from "react-hot-toast";
import { fileMimeType } from "../../../data/filemimetype";
import UploadCard from "../../upload_card/UploadCard";
import Button from "../../button/Button";
import axios from "axios";
import classes from "./Fssai_license.module.css";
...
const onSubmit = async (values) => {
  ...
  try {
    const res = await axios.post("/fssai/fssaiLicence", formData, {
      headers: {
    ...
    if (res.data.errorcode) {
      ...
      resetForm();
      toast.success("FSSAI License Submitted", { id: "fssai" });
    }
  } catch (error) {
    console.log(error);
