...
import classes from "./VehicleLoan.module.css";
...
const VehicleLoan = () => {
  ...
  return (
    <form className={classes.form} onSubmit={handleSubmit}>
      <div className={classes.radioGroup}>
        ...
        <label>
          <input
            type="radio"
            name="typeofLoan"
            value="vehicleLoanNew"
            checked={values.typeofLoan === "vehicleLoanNew"}
        ...
        <label>
          <input
            type="radio"
            name="typeofLoan"
            value="vehicleLoanUsed"
            checked={values.typeofLoan === "vehicleLoanUsed"}
            onChange={handleChange}
            onBlur={handleBlur}
          />
          Used
      ...
      {values.typeofLoan === "vehicleLoanNew" && (
        <>
          <input
      ...
      {values.typeofLoan === "vehicleLoanUsed" && (
        <>
          <input
            id={classes.styledInput}
            name="customerName"
